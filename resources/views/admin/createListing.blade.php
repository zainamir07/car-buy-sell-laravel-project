...
<div class="container mt-4">
    ...
    <p class="mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iusto nemo totam commodi, dolorem quia quaerat mollitia sint nulla recusandae quam!</p>
           <div class="container-fluid ">
            ...
            <form action="{{url('admin/listing/create')}}" method="post" id="form" enctype="multipart/form-data">
                @csrf
            ...
            <div class="mb-3 col-md-6">
              ...
              <div class="mb-3 col-md-6">
               ...
               <select name="company_name" id="company_name" class="form-control" value="{{old('company_name')}}">
                ...
                <small id="helpId" class="form-text text-danger">@error('car_number')
                    {{$message}}
                @enderror</small>
              </div>
              <div class="mb-3 col-md-6 model_name_div" hidden>
                <label for="model_name" class="form-label">Car Model Name</label>
               <select name="model_name" id="model_name" class="form-control" value="{{old('model_name')}}">
            ...
            <div class="row mt-2 bg-white pt-4 mt-4 pb-4 rounded">
              <div class="mb-3 col-md-12">
                <label for="price" class="form-label">Ad Description</label>
